...
void twist_callback(const geometry_msgs::TwistStamped::ConstPtr& msg, const gtsam::Pose3& iTv, const ros::Publisher& pub)
{
    rev_twist_msg = *msg;
...
int main(int argc, char *argv[])
{
    ...
    twist_sub = nh.subscribe<geometry_msgs::TwistStamped>(twist_sub_topic, 10, boost::bind(twist_callback, _1, imu_T_vicon, odom_pub));
